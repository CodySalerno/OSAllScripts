...
@ScriptManifest(name = "Regicide", author = "Iownreality1", info = "Regicide quest", version = 0.1, logo = "")
public class QuestRegicide extends Script
{
    ...
    public int onLoop() throws InterruptedException
    {
        ...
        int RegicideProg = configs.get(9999);
        log(RegicideProg);
        switch (RegicideProg) {
            case 0:
